export async function shinyAndFemaleSprites(
    ...
    if (showShiny) {
        if (currentGender.female &&
            ...
            currentSprite = sprites[1]?.shiny_front[1] ? sprites[1]?.shiny_front[1] : sprites[1]?.shiny_front[0];
        } else if (currentGender.female &&
            !sprites[1]?.shiny_front?.length &&
            sprites[1]?.front?.length) {
            localSelectionSprites = [...sprites[1]?.front];
            currentSprite = sprites[1]?.front[1] ? sprites[1]?.front[1] : sprites[1]?.front[0];
            ...
            if (sprites[0]?.shiny_front?.length) {
                ...
                currentSprite = sprites[0]?.shiny_front[1] ? sprites[0]?.shiny_front[1] : sprites[0]?.shiny_front[0];
        ...
        if (currentGender.female &&
            ...
            currentSprite = sprites[0]?.front[2] ? sprites[0]?.front[2] : sprites[0]?.front[0];
            if (currentGender.female &&
                (onScreenSprite &&
